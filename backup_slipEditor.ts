...
// ΓöÇΓöÇΓöÇ Single-leg helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export function reProfileLeg(match: Match, existingLeg: SlipLeg): EditResult {
  ...
  return {
    ...
    previousMarket: changed ? existingLeg.market : undefined,
    message: changed
      ? `Re-profiled: ${existingLeg.market} ΓåÆ ${best.market} (${analysis.profileLabel})`
 ...
 * (Tier 1, ΓëÑ68% probability) it is left untouched.
 */
export function optimizeLegSafely(match: Match, existingLeg: SlipLeg): EditResult {
  ...
  return {
    ...
    changed: true,
    previousMarket: existingLeg.market,
    message: `Upgraded safety: ${existingLeg.market} ΓåÆ ${safer.market}`,
  }
}

// ΓöÇΓöÇΓöÇ Goal-aware optimizer ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
